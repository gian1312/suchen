...
\end{figure}
We divide those two main tasks into the following subtasks:
\begin{itemize}
	\item Understand previously done work by Nikolay Savinov our Tutor
	\item Utilize interface of Vizdoom environment
	...
	\end{itemize}
	\item If there is time left we implement, train and test our agent with the PPO algorithm additionally

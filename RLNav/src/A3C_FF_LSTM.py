...
$ python A3C_FF_LSTM.py Pong-ram-v0 -a configs/vpg.json -n configs/mlp2_network.json -e 50000 -m 2000 -W 3

Or on CartPole-v0:
$ python A3C_FF_LSTM.py CartPole-v0 -a configs/vpg.json -n configs/mlp2_network.json -e 10000 -m 200 -W 3

You can check what the workers are doing:
$ tmux a -t A3C_FF_LSTM  # `ctrl+b d` to exit tmux

To kill the session:
$ python A3C_FF_LSTM.py CartPole-v0 -W 3 -K
"""
...
def main():
    ...
    session_name = 'A3C_FF_LSTM-' + args.gym_id
    shell = '/bin/bash'

...
class PPOAgent(LearningAgent):
    ...
    def initialize_model(self):
        states=self.states,
        print("HIIIIIIIIIIerereIIaaasasasaIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR\n")
        print(states)#added
        print("HIIIIIIIdrerereIasasasIIIIIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR\n")		    

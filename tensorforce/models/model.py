...
class Model(object):
    ...
    def __init__(
        ...
        #print("HaaaaaaaaaaaaaaaaaaEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR\n")
        #print(states)#added
        #print("HaaaaaaaaaaaaaaaaaaaEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR\n")	
        """
        Model.
    ...
    def setup(self):
        ...
        with tf.device(device_name_or_function=self.device):
            with tf.variable_scope(name_or_scope=self.scope, reuse=False):
                ...
                print("ttttttttttt model.py\n")
                print(self.states_input)#added
                print("ttttttttttttt model.py\n")	
                # Input tensors
                states = util.map_tensors(fn=tf.identity, tensors=self.states_input)
                print("sssssssss model.py\n")
                print(states)#added
                print("ssssssssssss model.py\n")	
                ...
                print("IIIIIIeeeIIIIIIaaasasasaIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR model.py\n")
                print(states)#added
                print("IIeeeeIIIIIIasasasIIIIIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR Model.py\n")
				
                states, actions, reward = self.fn_preprocess(states=states, actions=actions, reward=reward)

                print("TIIIIIIIIIIIIaaasasasaIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR Model.py\n")
                print(states)#added
                print("TIIIIIIIIasasasIIIIIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR Model.py\n")				
    ...
    def initialize(self, custom_getter):
        ...
        for name, state in self.states_spec.items():
            print('adsfasfdaf Model.py')
            print(util.tf_dtype(state['type']))
            print('asdfasdf Model.py')
            print('adsfasfdaf Model.py')
            print((0,) + tuple(state['shape']))
            print('asdfasdf Model.py')			
            print('adsfasfdaf Model.py')
            print(('state-'+name))
            print('asdfasdf Model.py')			
            self.states_input[name] = tf.placeholder(
                ...
                shape=(None,) + tuple(state['shape']), #Hier war ein ((none,) + tuple(state['shape']))
                name=('state-' + name)
            )
    ...
    def create_act_operations(self, states, internals, deterministic, independent):
        ...
        print("HIIIooooooooooooooooooooIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR Model.py\n")
        #print(states)#added
        print("HIIIooooooooooooooooooooIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR Model.py\n")
        operations = list()
    ...
    def create_operations(self, states, internals, actions, terminal, reward, deterministic, independent):
        ...
        """
        print("HIIuuuuuuIIIIIIIIIIIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR Model.py\n")
        print(states)#added
        print("HIIIIuuuuuuuuIIIIIIIIIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR Model.py\n")
    ...
    def act(self, states, internals, deterministic=False, independent=False, fetch_tensors=None):
        ...
        #print("vor Feeddict alskdjföalskjfdölaskjfdöalksdjf")
        #print(feed_dict)
        #print("blblb\n")
        #print(fetches)
        #print("vor Feeddict alskdjföalskjfdölaskjfdöalksdjf")
        ...
        if self.network is not None and fetch_tensors is not None:
            ...
            print("oben Model.py")
            print(actions, internals, timestep, fetch_dict)
            return actions, internals, timestep, fetch_dict

        else:
            print("unten model.py")
            print(actions, internals, timestep)

...
class Linear(Layer):
    ...
    def tf_apply(self, x, update=False):
        print("HIIIIIIIIIIIIIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR\n")
        print(x)#added
        print("HIIIIIIIIIIIIIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR\n")
        if util.rank(x) != 2:
            print("HIIIIIIIIIIIIIIIIIIIIEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR\n")
...
class Dense(Layer):
    ...
    def tf_apply(self, x, update):
        print("HuuuuuuuuuuuuuuuuuuuuuuuuuEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR\n")
        print(x)#added
        print("HuuuuuuuuuuuuuuuuuuuuuEEEEEEEEEEEEEEEEEEEEERRRRRRRRRRRRRRRRRRRRRRR\n")
